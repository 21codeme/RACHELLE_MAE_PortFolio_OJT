  ...
  return (
    <div className='min-h-screen p-4 sm:p-6 md:p-8'>
      <div className='max-w-7xl mx-auto'>
        ...
        <h1 className='text-2xl sm:text-3xl font-bold text-foreground mb-2'>Appendices</h1>
        <p className='text-muted-foreground mb-8'>Supporting documents, attachments, and visual evidence of internship completion.</p>
          ...
          <section id='section-appendices-grid'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
              {appendices.map((appendix) => (
                <div
                  key={appendix.id}
                  className='bg-secondary/50 backdrop-blur border border-border/50 rounded-xl p-6 hover:border-primary/50 hover:bg-secondary/80 transition-all duration-300 group'
                >
      ...
      {selectedAppendix && (
        ...
        >
          ...
          >
            ...
            {/* Controls */}
            <div className='flex items-center justify-center gap-3 p-3 border-b border-border bg-secondary/50 flex-wrap'>
              <button
              ...
              {selectedAppendix.imagePaths.length > 1 && (
                <>
                  ...
                  <span className='text-foreground text-sm font-semibold min-w-[80px] text-center'>
